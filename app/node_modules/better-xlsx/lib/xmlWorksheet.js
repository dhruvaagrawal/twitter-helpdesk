...
var _getPrototypeOf20 = _interopRequireDefault(require("@babel/runtime/helpers/getPrototypeOf"));
...
var Xworksheet = _decorate([(0, _node.props)('xmlns', 'xmlns:r')], function (_initialize, _Node) {
  ...
  function (_Node2) {
    ...
    function Xworksheet() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf20.default)(Xworksheet).call(this, attrs, children));
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return (0, _get2.default)((0, _getPrototypeOf20.default)(Xworksheet.prototype), "render", this).call(this);
      }
    }]
  };
}, _node.Node);
...
var XsheetPr = _decorate([(0, _node.props)('filterMode')], function (_initialize2, _Node3) {
  ...
  function (_Node4) {
    ...
    function XsheetPr() {
      ...
      _this2 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf20.default)(XsheetPr)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
var XpageSetUpPr = _decorate([(0, _node.props)('fitToPage')], function (_initialize3, _Node5) {
  ...
  function (_Node6) {
    ...
    function XpageSetUpPr() {
      ...
      _this3 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf3 = (0, _getPrototypeOf20.default)(XpageSetUpPr)).call.apply(_getPrototypeOf3, [this].concat(args)));
...
var Xdimension = _decorate([(0, _node.props)('ref')], function (_initialize4, _Node7) {
  ...
  function (_Node8) {
    ...
    function Xdimension() {
      ...
      _this4 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf4 = (0, _getPrototypeOf20.default)(Xdimension)).call.apply(_getPrototypeOf4, [this].concat(args)));
...
function (_Node9) {
  ...
  function XsheetViews() {
    ...
    _this5 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf5 = (0, _getPrototypeOf20.default)(XsheetViews)).call.apply(_getPrototypeOf5, [this].concat(args)));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this5), "__name", "sheetViews");
    return _this5;
  }
...
var XsheetView = _decorate([(0, _node.props)('windowProtection', 'showFormulas', 'showGridLines', 'showRowColHeaders', 'showZeros', 'rightToLeft', 'tabSelected', 'showOutlineSymbols', 'defaultGridColor', 'view', 'topLeftCell', 'colorId', 'zoomScale', 'zoomScaleNormal', 'zoomScalePageLayoutView', 'workbookViewId')], function (_initialize5, _Node10) {
  ...
  function (_Node11) {
    ...
    function XsheetView() {
      ...
      _this6 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf6 = (0, _getPrototypeOf20.default)(XsheetView)).call.apply(_getPrototypeOf6, [this].concat(args)));

      _initialize5((0, _assertThisInitialized2.default)(_this6));
...
var Xselection = _decorate([(0, _node.props)('pane', 'activeCell', 'activeCellId', 'sqref')], function (_initialize6, _Node12) {
  ...
  function (_Node13) {
    ...
    function Xselection() {
      ...
      _this7 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf7 = (0, _getPrototypeOf20.default)(Xselection)).call.apply(_getPrototypeOf7, [this].concat(args)));

      _initialize6((0, _assertThisInitialized2.default)(_this7));
...
var Xpane = _decorate([(0, _node.props)('xSplit', 'ySplit', 'topLeftCell', 'activePane', 'state')], function (_initialize7, _Node14) {
  ...
  function (_Node15) {
    ...
    function Xpane() {
      ...
      _this8 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf8 = (0, _getPrototypeOf20.default)(Xpane)).call.apply(_getPrototypeOf8, [this].concat(args)));

      _initialize7((0, _assertThisInitialized2.default)(_this8));
...
var XsheetFormatPr = _decorate([(0, _node.props)('defaultColWidth', 'defaultRowHeight', 'outlineLevelCol', 'outlineLevelRow')], function (_initialize8, _Node16) {
  ...
  function (_Node17) {
    ...
    function XsheetFormatPr() {
      ...
      _this9 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf9 = (0, _getPrototypeOf20.default)(XsheetFormatPr)).call.apply(_getPrototypeOf9, [this].concat(args)));

      _initialize8((0, _assertThisInitialized2.default)(_this9));
...
function (_Node18) {
  ...
  function Xcols() {
    ...
    _this10 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf10 = (0, _getPrototypeOf20.default)(Xcols)).call.apply(_getPrototypeOf10, [this].concat(args)));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this10), "__name", "cols");
    return _this10;
  }
...
var Xcol = _decorate([(0, _node.props)('collapsed', 'hidden', 'max', 'min', 'style', 'width', 'customWidth', 'outlineLevel')], function (_initialize9, _Node19) {
  ...
  function (_Node20) {
    ...
    function Xcol() {
      ...
      _this11 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf11 = (0, _getPrototypeOf20.default)(Xcol)).call.apply(_getPrototypeOf11, [this].concat(args)));

      _initialize9((0, _assertThisInitialized2.default)(_this11));
...
function (_Node21) {
  ...
  function XsheetData() {
    ...
    _this12 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf12 = (0, _getPrototypeOf20.default)(XsheetData)).call.apply(_getPrototypeOf12, [this].concat(args)));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this12), "__name", "sheetData");
    return _this12;
  }
...
var Xrow = _decorate([(0, _node.props)('r', 'spans', 'hidden', 'ht', 'customHeight', 'outlineLevel')], function (_initialize10, _Node22) {
  ...
  function (_Node23) {
    ...
    function Xrow() {
      ...
      _this13 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf13 = (0, _getPrototypeOf20.default)(Xrow)).call.apply(_getPrototypeOf13, [this].concat(args)));

      _initialize10((0, _assertThisInitialized2.default)(_this13));
...
var Xc = _decorate([(0, _node.props)('r', 's', 't')], function (_initialize11, _Node24) {
  ...
  function (_Node25) {
    ...
    function Xc(attrs, children) {
      ...
      _this14 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf20.default)(Xc).call(this, attrs, children));

      _initialize11((0, _assertThisInitialized2.default)(_this14));
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return (0, _get2.default)((0, _getPrototypeOf20.default)(Xc.prototype), "render", this).call(this);
      }
    }]
  };
}, _node.Node);
...
var Xf = _decorate([(0, _node.props)('t', 'ref', 'si')], function (_initialize12, _Node26) {
  ...
  function (_Node27) {
    ...
    function Xf() {
      ...
      _this15 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf14 = (0, _getPrototypeOf20.default)(Xf)).call.apply(_getPrototypeOf14, [this].concat(args)));

      _initialize12((0, _assertThisInitialized2.default)(_this15));
...
var XmergeCells = _decorate([(0, _node.props)('count')], function (_initialize13, _Node28) {
  ...
  function (_Node29) {
    ...
    function XmergeCells() {
      ...
      _this16 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf15 = (0, _getPrototypeOf20.default)(XmergeCells)).call.apply(_getPrototypeOf15, [this].concat(args)));

      _initialize13((0, _assertThisInitialized2.default)(_this16));
...
var XmergeCell = _decorate([(0, _node.props)('ref')], function (_initialize14, _Node30) {
  ...
  function (_Node31) {
    ...
    function XmergeCell() {
      ...
      _this17 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf16 = (0, _getPrototypeOf20.default)(XmergeCell)).call.apply(_getPrototypeOf16, [this].concat(args)));

      _initialize14((0, _assertThisInitialized2.default)(_this17));
...
var XprintOptions = _decorate([(0, _node.props)('headings', 'gridLines', 'gridLinesSet', 'horizontalCentered', 'verticalCentered')], function (_initialize15, _Node32) {
  ...
  function (_Node33) {
    ...
    function XprintOptions() {
      ...
      _this18 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf17 = (0, _getPrototypeOf20.default)(XprintOptions)).call.apply(_getPrototypeOf17, [this].concat(args)));

      _initialize15((0, _assertThisInitialized2.default)(_this18));
...
var XpageMargins = _decorate([(0, _node.props)('left', 'right', 'top', 'bottom', 'header', 'footer')], function (_initialize16, _Node34) {
  ...
  function (_Node35) {
    ...
    function XpageMargins() {
      ...
      _this19 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf18 = (0, _getPrototypeOf20.default)(XpageMargins)).call.apply(_getPrototypeOf18, [this].concat(args)));

      _initialize16((0, _assertThisInitialized2.default)(_this19));
...
var XpageSetup = _decorate([(0, _node.props)('paperSize', 'scale', 'firstPageNumber', 'fitToWidth', 'fitToHeight', 'pageOrder', 'orientation', 'usePrinterDefaults', 'blackAndWhite', 'draft', 'cellComments', 'useFirstPageNumber', 'horizontalDpi', 'verticalDpi', 'copies')], function (_initialize17, _Node36) {
  ...
  function (_Node37) {
    ...
    function XpageSetup() {
      ...
      _this20 = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf19 = (0, _getPrototypeOf20.default)(XpageSetup)).call.apply(_getPrototypeOf19, [this].concat(args)));

      _initialize17((0, _assertThisInitialized2.default)(_this20));
...
var XheaderFooter = _decorate([(0, _node.props)('differentFirst', 'differentOddEven')], function (_initialize18, _Node38) {
  ...
  function (_Node39) {
    ...
    function XheaderFooter(attrs, children) {
      ...
      _this21 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf20.default)(XheaderFooter).call(this, attrs, children));

      _initialize18((0, _assertThisInitialized2.default)(_this21));
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return (0, _get2.default)((0, _getPrototypeOf20.default)(XheaderFooter.prototype), "render", this).call(this);
      }
    }]
  };
}, _node.Node);
